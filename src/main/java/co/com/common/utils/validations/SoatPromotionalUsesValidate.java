...
public class SoatPromotionalUsesValidate {
    public static final String ID_NOT_NULL = "El ID del uso de la promoción con SOAT no puede ser nulo";
    ...
    public static final String IDENTIFICATION_NOT_EMPTY = "La identificación de la promoción con SOAT no puede estar vacía";
    public static final String IDENTIFICATION_ALREADY_USED = "El código con ID %s ya fue utilizada para promoción";

    public static final String QUANTITY_LITERS_NOT_NULL = "La cantidad de litros de la promoción para consumidor final no puede ser nula";
